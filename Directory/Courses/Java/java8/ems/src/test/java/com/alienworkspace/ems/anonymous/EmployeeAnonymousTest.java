...
import com.alienworkspace.ems.EmployeeFilter;
import com.alienworkspace.ems.EmployeeYearsOfExperienceFilter;
...
public class EmployeeAnonymousTest {
    ...
    public static void main(String arg[]) {
        ...
        List<Employee> allInFS = getAllEmployeeFilterBy(new EmployeeAnonymousFilter(){
            @Override
            public boolean filter(Employee employee){
                return employee.getUnit().equals(Unit.FS);
            }
        });
        ...
        List<Employee> allDevelopersWithYearsOfExperience = getAllEmployeeFilterBy(new EmployeeAnonymousFilter() {
            @Override
            public boolean filter(Employee employee){
    ...
    private static List<Employee> getAllEmployeeFilterBy(EmployeeAnonymousFilter employeeFilter) {
