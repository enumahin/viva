package com.alienworkspace.ems.predicateinterface;
...
public class EmployeePredicateTest {
    ...
    public static void main(String arg[]) {
        ...
        Predicate<Employee> edcEmployees = employee -> employee.getUnit().equals(Unit.EDC);
        List<Employee> allInEdc = getAllEmployeeFilterBy(edcEmployees);
        ...
        Predicate<Employee> employeeWithJavaSkills = employee -> employee.getSkills().contains(Skill.JAVA);
        List<Employee> allJavaDevelopers = getAllEmployeeFilterBy(employeeWithJavaSkills);
        ...
        // 5. How will you implement the requirement Java Developers in EDC ?
//        List<Employee> javaDevelopersInEDC = getAllEmployeeFilterBy(employee -> employee.getSkills().contains(Skill.JAVA)
//                && employee.getUnit().equals(Unit.EDC));
        List<Employee> javaDevelopersInEDC = getAllEmployeeFilterBy(employeeWithJavaSkills.and(edcEmployees));
        System.out.println("-----------Java Developers in EDC--------------");
        System.out.println(javaDevelopersInEDC);
    }

    private static List<Employee> getAllEmployeeFilterBy(Predicate<Employee> employeeFilter) {
